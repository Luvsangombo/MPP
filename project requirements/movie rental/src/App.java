...
public class App {
        public static void main(String[] args) throws Exception {
                ...
                Director retrievedDirector = (Director) FileStorageUtil.getObject("1",
                                FileStorageUtil.StorageType.DIRECTOR);
                ...
                System.out.println("Updated Director: "
                                + FileStorageUtil.getObject("1", FileStorageUtil.StorageType.DIRECTOR));
                ...
                MemberUser retrievedUser = (MemberUser) FileStorageUtil.getObject("1",
                                FileStorageUtil.StorageType.MEMBERS);
                ...
                System.out
                                .println("Updated MemberUser: "
                                                + FileStorageUtil.getObject("1", FileStorageUtil.StorageType.MEMBERS));
